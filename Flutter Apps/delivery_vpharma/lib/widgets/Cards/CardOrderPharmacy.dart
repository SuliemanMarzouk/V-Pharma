...
class CardOrderPharmacy extends StatelessWidget {
  OrderPharmacy? order;
  CardOrderPharmacy({this.order});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(""),
            Text("From: Warehouse ${order!.warehouse!.WHName} "),
            Text("Address Warehouse: ${order!.warehouse!.Address} "),
            Text("Phone Warehouse: ${order!.warehouse!.PhoneNum} "),
            Text(""),
            Text("To: Pharmacy ${order!.pharmacy!.PharmaName} "),
                              ...
                              style: ButtonStyle(
                                  backgroundColor:
                                      MaterialStateColor.resolveWith(
                                          (states) => Colors.green)),
                              onPressed: () async {
                                await cartProvider.updatestausorderpharmacy(
