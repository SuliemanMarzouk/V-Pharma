                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="col-lg-6 d-none d-lg-block">
                            <img src="admin/img/w01.png" alt="Login Image" style="width: 100%; height: 100%;">
                        </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="{{ route('login') }}" class="user">
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a class="small" href="https://aspu.edu.sy/">you don't have an account?! Contact with us</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
