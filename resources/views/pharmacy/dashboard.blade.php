                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-pills fa-2x text-gray-300"></i> <!-- Replace with desired icon class -->
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <a href="/myOrders">
                                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">My Orders
                                                </div>
                                            </a>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $myOrdersCount }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
