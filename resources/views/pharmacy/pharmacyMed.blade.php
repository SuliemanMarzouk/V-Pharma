...
<body id="page-top">
    ...
    <div class="container">
                            ...
                            <tbody>
                                @foreach ($medicines as $medicine)
                                    <tr>
                                        ...
                                        <td>
                                            @foreach ($medicine->pharmacies as $pharmacy)
                                                @if ($pharmacy->user_id === Auth::user()->id)
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <form id="delete-form-{{ $medicine->ID }}"
                                                action="{{ route('pharmamedicines.destroy', $medicine->ID) }}"
                                                method="POST"
                                                style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <!-- Edit modal -->
                                        @include('pharmacy/modals/edit_medicine_modal', ['medicine' => $medicine])
                                @endforeach
                            </tbody>
                        </table>
                    </div>
        ...
        @include('pharmacy/modals/add_medicine_modal')
</div>
</div>
</div>
    ...
    <script src="{{ asset('admin/js/mypharma.js') }}"></script>
