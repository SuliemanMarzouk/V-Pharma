...
<div class="modal fade" id="editMedicineModal-{{ $medicine->ID }}" tabindex="-1" role="dialog" aria-labelledby="editMedicineModalLabel-{{ $medicine->ID }}" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="editMedicineForm" action="{{ route('pharmamedicines.update', $medicine->ID) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="quantity" name="quantity" value="{{ $medicine->pharmacies()->first()->pivot->Quantity }}" required>
                    </div>
                    <div class="form-group">
                        <label for="price">Price</label>
                        <input type="number" step="0.01" class="form-control" id="price" name="price" value="{{ $medicine->pharmacies()->first()->pivot->Price }}" required>
                    </div>
                    <div class="form-group">
