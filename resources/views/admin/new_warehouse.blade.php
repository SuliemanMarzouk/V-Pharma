                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create an Account Warehouse!</h1>
                            </div>
                            <form class="user" method="POST" action="{{ route('warehouse.store') }}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="number" class="form-control form-control-user" id="WHLicense" placeholder="Warehouse License Number" name="WHLicense">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="WHName" placeholder="Warehouse Name" name="WHName">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="WHAddress" placeholder="Address" name="Address">
                                </div>

                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" id="WHPhoneNumber" placeholder="Phone Number" name="PhoneNum">
                                </div>
