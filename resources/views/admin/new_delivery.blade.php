                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create an Account Delivery!</h1>
                            </div>
                            <form class="user" method="POST" action="{{ route('delivery.store') }}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="number" class="form-control form-control-user" id="NationNum" placeholder="Delivery Nation Number" name="NationNum">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="DFullName" placeholder="Delivery Full Name" name="FullName">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" id="DPhoneNumber" placeholder="Phone Number" name="PhoneNum">
                                </div>
